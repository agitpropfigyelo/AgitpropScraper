...
public static class JobDescriptionFactory
{
    ...
    public static ScrapingJobDescription GetAgitpropScrapingJob(NewsSites site)
    {
        return site switch
        {
            ...
            NewsSites.Kuruczinfo => new ScrapingJobDescription { Url = new Uri("https://kuruc.info/to/1/20/"), Type = PageContentType.Archive },
            ...
            NewsSites.Telex => new ScrapingJobDescription { Url = new Uri("https://telex.hu/legfrissebb?oldal=1"), Type = PageContentType.Archive },
